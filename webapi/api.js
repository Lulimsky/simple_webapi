...
let log = document.getElementById("clkbtn").querySelectorAll(".signup-box");
...
login.addEventListener("click", () => {
  ...
  //let singup-box = document.querySelector(".userlogin").textContent,
  //let login-box = document.querySelector(".password").textContent;
});
